...
const ExploreMenu = ({category,setCategory})=>{
    return(
        <div className='explore-menu' id='explore-menu'>
            ...
            <p className='explore-menu-text '>Choose from diverse menu featuring a delectable array of dishes crafted with the finest ingridients and satisfy your cravings and elevate your experience, one delicious meal at a time.</p>
